            ...
            <li>
                <a href="home?action=list"
                   class="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">All</span>
                </a>
            </li>
            <li>
                <a href="home?action=laptop"
                   class="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Laptop</span>
                </a>
            </li>
            <li>
                <a href="home?action=tablet"
                   class="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Tablet</span>
                </a>
            </li>
            <li>
                <a href="home?action=printer_scanner"
                   class="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Printer and Scanner</span>
                </a>
            </li>
            <li>
                <a href="home?action=phone"
                   class="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Smart Phone</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="home?action=monitor"
                   class="flex items-center p-4 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Monitor</span>
                </a>
            </li>
            <li>
                <a href="home?action=robot"
                   class="flex items-center p-4 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg height="64px" width="64px" version="1.1" id="_x32_"
                         class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                         xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 512 512" xml:space="preserve" fill="#ffffff" stroke="#ffffff"><g
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <g>
                                <path class="st0"
                                      d="M202.622,344.796l-6.208,11.926l-0.263,0.484c-14.411,24.499-41.026,39.714-69.478,39.714 c-14.272,0-28.371-3.847-40.731-11.122c-18.544-10.908-31.733-28.37-37.122-49.195c-0.238-0.886-0.434-1.78-0.632-2.674 L37.92,412.74h173.617L202.622,344.796z"></path>
                                <path class="st0"
                                      d="M212.883,59.091L66.446,280.944c-19.578,33.283-8.465,76.172,24.844,95.749 c33.299,19.587,76.17,8.464,95.756-24.843l99.391-191.063l-54.788-52.082C217.361,93.974,212.497,77.52,212.883,59.091z M150.794,330.533c-7.808,13.288-24.909,17.716-38.188,9.916c-13.287-7.824-17.724-24.909-9.907-38.196 c7.808-13.288,24.909-17.716,38.187-9.908C154.165,300.161,158.611,317.254,150.794,330.533z"></path>
                                <path class="st0"
                                      d="M216.401,422.247H34.278c-12.402,0-22.449,10.055-22.449,22.457V512h227.012v-67.296 C238.841,432.302,228.794,422.247,216.401,422.247z"></path>
                                <path class="st0"
                                      d="M450.024,185.737c7.184,0,14.082,1.255,20.48,3.559L328.505,19.542c-22.646-24.606-60.956-26.188-85.554-3.535 c-24.606,22.637-26.18,60.949-3.535,85.546l149.955,142.458C390.65,211.663,417.356,185.737,450.024,185.737z M299.584,77.537 c-9.374,8.628-23.973,8.013-32.602-1.361c-8.645-9.375-8.038-23.974,1.345-32.603c9.375-8.644,23.974-8.038,32.619,1.346 C309.575,54.293,308.967,68.892,299.584,77.537z"></path>
                                <polygon class="st0"
                                         points="431.668,365.227 451.246,387.249 470.815,365.227 470.815,328.975 431.668,328.975 "></polygon>
                                <path class="st0"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Robot</span>
                </a>
            </li>
            <li>
                <a href="home?action=server"
                   class="flex items-center p-4 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Server</span>
                </a>
            </li>
            ...
            <li>
                <a href="home?action=networking"
                   class="flex items-center p-4 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Networking</span>
                </a>
            </li>
            <li>
                   ...
                   class="flex items-center p-4 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg width="94px" height="94px" viewBox="0 0 16 16"
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                           stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="m 8 0 c -1.230469 0 -2.4375 0.324219 -3.5 0.9375 c -2.164062 1.25 -3.5 3.5625 -3.5 6.0625 v 6 s 0 2 2 2 h 1 c 0.554688 0 1 -0.445312 1 -1 v -4 c 0 -0.554688 -0.5 -1 -1 -1 c 0 0 -1 0 -1 -1 v -1 c 0 -1.785156 0.953125 -3.4375 2.5 -4.332031 c 1.546875 -0.890625 3.453125 -0.890625 5 0 c 1.546875 0.894531 2.5 2.546875 2.5 4.332031 v 1 c 0 1 -1 1 -1 1 c -0.5 0 -1 0.445312 -1 1 v 4 c 0 0.554688 0.445312 1 1 1 h 1 c 2 0 2 -2 2 -2 v -6 c 0 -2.5 -1.335938 -4.8125 -3.5 -6.0625 c -1.0625 -0.613281 -2.269531 -0.9375 -3.5 -0.9375 z m 0 0"
                                  fill="#ffffff"></path>
                        </g>
                    </svg>
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Audio-Visual</span>
                </a>
            </li>
            <li>
                   ...
                   class="flex items-center p-4 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg fill="#ffffff" width="94px" height="94px" viewBox="0 0 1000 1000"
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                           stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M244 416q-35 0-59.5 24.5T160 500t24.5 59.5T244 584t59.5-24.5T328 500t-24.5-59.5T244 416zm256 0q-35 0-59.5 24.5T416 500t24.5 59.5 59 24.5 59.5-24.5 25-59.5-25-59.5-60-24.5h1zm256 0q-35 0-59.5 24.5T672 500t24.5 59.5T756 584t59.5-24.5T840 500t-24.5-59.5T756 416z"></path>
                        </g>
                    </svg>
                    <span class="flex-1 ms-3 whitespace-nowrap font-bold">Others</span>
                </a>
            </li>
        </ul>
    </div>
