            ...
            <div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-4 h-full">
                            ...
                            <div class="space-y-6 mt-10">
                                <div class="grid sm:grid-cols-2 items-start gap-6">
                                    ...
                                    <sql:query dataSource="${bookDetails}" var="result">
                                        ...
                                        <%--                                        SELECT--%>
                                        <%--                                        booking.bookingID AS b_bkID,--%>
                                        <%--                                        booking.userID AS userID,--%>
                                        <%--                                        booking.bookingDate AS b_bkDate,--%>
                                        <%--                                        booking.pickupDate AS b_pkDate,--%>
                                        <%--                                        booking.returnDate AS b_returnDate,--%>
                                        <%--                                        booking.bookingStatus AS b_status,--%>
                                        <%--                                        booking.rejectReason,--%>
                                        <%--                                        bookingequipment.bookingEquipmentID AS b_bkEqID,--%>
                                        <%--                                        bookingequipment.bookingID AS b_bkEBID,--%>
                                        <%--                                        bookingequipment.equipmentID AS b_EqID,--%>
                                        <%--                                        equipment.equipmentID AS e_eID,--%>
                                        <%--                                        equipment.equipmentName AS e_name,--%>
                                        <%--                                        equipment.equipmentType AS e_type,--%>
                                        <%--                                        equipment.serialNumber AS e_sno,--%>
                                        <%--                                        equipment.purchaseDate AS e_pdate,--%>
                                        <%--                                        equipment.warrantyPeriod AS e_wperiod,--%>
                                        <%--                                        equipment.status AS e_status,--%>
                                        <%--                                        equipment.private AS e_private,--%>
                                        <%--                                        equipment.campusID AS e_campusID--%>
                                        <%--                                        FROM booking--%>
                                        <%--                                        LEFT JOIN bookingequipment ON booking.bookingID = bookingequipment.bookingID--%>
                                        <%--                                        LEFT JOIN equipment ON bookingequipment.equipmentID = equipment.equipmentID--%>
                                        <%--                                        WHERE booking.userID =  ${sessionScope.userID} AND booking.bookingID =  ${param.bookID};--%>
                                    </sql:query>
                                        ...
                                        <div class="p-2">
                                            ...
                                            <ul class="text-xs text-white space-y-3 mt-4">
                                                ...
                                                <li class="flex flex-wrap gap-4 text-2xl text-red-500">${b.status}
                                                    ...
                                                    <%--                                                <li class="flex flex-wrap gap-4 text-2xl">${row.nextBookingID}--%>
                                                    <%--                                                </li>--%>
                                                    <%--                                                <li class="flex flex-wrap gap-4  text-2xl ">--%>
                                                    <%--                                                    <button--%>
                                                    <%--                                                            onclick="removeCheckoutItem(${row.equipmentID})"--%>
                ...
                <div class="xl:col-span-2 h-max rounded-md p-8 sticky top-0">
                    ...
                    <form class="mt-10">
                        ...
                        <%--                                    </sql:query>--%>
                        <%--                                    &lt;%&ndash;                                    <input type="number" value="" disabled&ndash;%&gt;--%>
                        <%--                                    &lt;%&ndash;                                           class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />&ndash;%&gt;--%>
